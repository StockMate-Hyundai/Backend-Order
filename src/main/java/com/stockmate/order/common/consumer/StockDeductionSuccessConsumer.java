...
public class StockDeductionSuccessConsumer {
    ...
    public void handleStockDeductionSuccess(@Payload StockDeductionSuccessEvent event, Acknowledgment acknowledgment) {
        ...
        try {
            ...
            log.error("재고 차감 성공 이벤트 처리 실패 - Order ID: {}, 에러: {}",
